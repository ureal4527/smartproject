        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area">
                        <a href="/" class="logo-lsg"><img src="img/logo/logo.png" alt="" />Login SeoGwang</a>
                    </div>
                </div>
                    ...
                    <div class="mobile-menu">
                        ...
                        <!--       ------------------------------------------------------------------------------               -->
                            <ul class="mobile-menu-nav">
                                <li><a data-toggle="collapse" data-target="#Charts" href="index.do">Home</a>
                                                                   </li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li class="active"><a " href="/"><i class="notika-icon notika-house"></i> Home1111</a>
                        </li>
